    ...
    <main className="premium-bg min-h-screen text-white">
      ...
      <section className="mx-auto max-w-4xl px-5 py-20 lg:px-8">
        <div className="glass-card rounded-[34px] p-8 md:p-10">
          <div className="text-xs font-black uppercase tracking-[0.32em] text-[#5BA3FF]">Legal</div>
          ...
          <div className="mt-8 grid gap-7 leading-8 text-slate-300">
            ...
            <p>Questions: <a className="text-[#5BA3FF]" href="mailto:support@taxsoletrader.com">support@taxsoletrader.com</a></p>
          </div>
        </div>
      </section>
      <SiteFooter />
