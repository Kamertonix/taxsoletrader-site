    ...
    <main className="premium-bg min-h-screen text-white">
      ...
      <section className="mx-auto max-w-4xl px-5 py-20 lg:px-8">
        <div className="glass-card rounded-[34px] p-8 md:p-10">
          <div className="text-xs font-black uppercase tracking-[0.32em] text-blue-300">Contact</div>
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2">
            <div className="rounded-[28px] border border-white/10 bg-white/[0.04] p-6">
              ...
              <a className="mt-4 block text-cyan-300" href="mailto:support@taxsoletrader.com">support@taxsoletrader.com</a>
