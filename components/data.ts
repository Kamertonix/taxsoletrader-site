...
export const pricingPlans = [
  ...
  },
  {
    ...
    description: 'Every Premium feature below, unlocked for 14 days on us — no card, no commitment.',
    features: [
  ...
  },
  {
    ...
    badge: 'MOST POPULAR',
    price: '£3.99',
    priceSuffix: '/month for 3 months',
    strikePrice: '£7.99',
    afterNote: 'then £7.99/month, billed monthly',
    note: 'Includes the 14-day free trial',
    highlight: true,
    cta: 'Start Monthly',
  ...
  },
  {
    ...
    price: '£79.99',
    priceSuffix: '/year',
    note: 'No intro offer — already ~£6.67/month',
    highlight: false,
    cta: 'Start Annual',
